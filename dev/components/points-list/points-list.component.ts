...
import {TopSupportComponent} from '../top-support/top-support.component';
import {MoreSupportComponent} from '../more-support/more-support.component';
...
@Component({
    ...
    template: require('dev/components/points-list/points-list.tpl.html'),
